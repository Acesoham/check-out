...
interface Application {
  ...
  formType: 'Water Cleanliness' | 'Cleaning Services';
  formUrl: string;
  uploadedPdf?: string;
  query?: string;
}
...
const generateMockApplications = (count: number): Application[] => {
  ...
  const formTypes: Application['formType'][] = ['Water Cleanliness', 'Cleaning Services'];
...
const ComplaintDashbord= () => {
  ...
  const translations = {
    en: {
      dashboardTitle: 'Complaint Dashboard',
      totalJobCardHolders: 'Total Complaints',
      totalJobCards: 'Escalated',
      activeJobCards: 'Resolved',
      pendingApplications: 'Pending Complaints',
      jobCardStatus: 'Cleaning Services Complaint Status',
      kaamMagniArjStatus: 'Water Cleanliness Complaint Status',
      complaintStatus: 'Complaint Status',
      recentJobCardHolders: 'Recent Complaints',
      recentComplaints: 'Recent Escalations',
      name: 'Name',
      village: 'Village',
      issuedOn: 'Submitted On',
      status: 'Status',
      view: 'View',
      subject: 'Subject',
      jobCardHolder: 'Complainant',
      date: 'Date',
      priority: 'Priority',
      userDetails: 'Complaint Details',
      close: 'Close',
      jobCardID: 'Complaint ID',
      address: 'Address',
      phone: 'Phone',
      bankAccount: 'Bank Account',
      familyMembers: 'Family Members',
      lastWorkedOn: 'Last Updated On',
      applicationsReceived: 'Complaints Received',
      applicantName: 'Complainant Name',
      applicationDate: 'Submission Date',
      formType: 'Complaint Type',
      form: 'Form',
      actions: 'Actions',
      approve: 'Approve',
      reject: 'Reject',
      ...
      noRecentUsers: 'No recent complaints found.',
      noRecentComplaints: 'No recent escalations found.',
      noApplications: 'No complaints received.',
      all: 'All',
    ...
    mr: {
      ...
      pendingApplications: 'प्रलंबित तक्रारी',
      jobCardStatus: 'स्वच्छता सेवा तक्रार स्थिती',
      kaamMagniArjStatus: 'पाणी स्वच्छता तक्रार स्थिती',
      complaintStatus: 'तक्रार स्थिती',
      recentJobCardHolders: 'नवीन तक्रारी',
      recentComplaints: 'नवीन एस्कलेशन्स',
      name: 'नाव',
      village: 'गाव',
      issuedOn: 'सबमिट केल्याची तारीख',
      status: 'स्थिती',
      view: 'पहा',
      subject: 'विषय',
      jobCardHolder: 'तक्रारदार',
      date: 'तारीख',
      priority: 'प्राधान्य',
      userDetails: 'तक्रार तपशील',
      close: 'बंद करा',
      jobCardID: 'तक्रार आयडी',
      address: 'पत्ता',
      phone: 'फोन',
      bankAccount: 'बँक खाते',
      familyMembers: 'कुटुंब सदस्य',
      lastWorkedOn: 'शेवटचे अद्यतन',
      applicationsReceived: 'प्राप्त तक्रारी',
      applicantName: 'तक्रारदाराचे नाव',
      applicationDate: 'सबमिशन तारीख',
      formType: 'तक्रार प्रकार',
      form: 'फॉर्म',
      actions: 'क्रिया',
      approve: 'मंजूर करा',
      reject: 'नाकारा',
      ...
      noRecentUsers: 'नवीन तक्रारी आढळल्या नाहीत.',
      noRecentComplaints: 'नवीन एस्कलेशन्स आढळले नाहीत.',
      noApplications: 'तक्रारी प्राप्त झाल्या नाहीत.',
      all: 'सर्व',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      setLoading(false);
      setNotifications([
        { id: '1', message: 'New complaint received!', type: 'info' },
        { id: '2', message: 'Complaint escalated: Water quality issue', type: 'warning' },
      ]);
    }, 1500);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="bg-gradient-to-r from-blue-100 to-blue-300 dark:from-blue-900 dark:to-blue-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400 font-medium">Total number of registered complaints</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-r from-green-100 to-green-300 dark:from-green-900 dark:to-green-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400 font-medium">Total number of complaints received</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-r from-yellow-100 to-yellow-300 dark:from-yellow-900 dark:to-yellow-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400 font-medium">Number of resolved complaints</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-r from-red-100 to-red-300 dark:from-red-900 dark:to-red-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400 font-medium">Number of pending complaints</CardDescription>
          </CardHeader>
          <CardContent>
...
<Card className="shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
  ...
  <CardContent className="flex justify-center">
   ...
   {/* Water Cleanliness Complaint Donut Chart */}
<Card className="shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
  <CardHeader>
  <CardTitle className="text-xl font-semibold text-indigo-600 dark:text-indigo-300 flex items-center">
  <PieChart className="mr-2 h-5 w-5 text-indigo-600 dark:text-indigo-400" />
 ...
 {/* <Card className="shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
  ...
  {/* User Details Modal */}
    ...
    export default ComplaintDashbord;